  ...
  <![endif]-->
    ...
    <div class="container">
      ...
      <div class="content">
        ...
        <!-- Accordion -->
          ...
          <!--start filamentgroup datepicker-->
            <link href="media/plugin/jQuery-UI-Date-Range-Picker/css/ui.daterangepicker.css" media="screen" rel="Stylesheet" type="text/css" />
            ...
            <!--begin wijmo menu-->
              <link href="media/plugin/wijmo/jquery.wijmo-open.1.5.0.css" rel="stylesheet" type="text/css" />
              <style>
                  .wijmo-container
                  {
                      display: block;
        ...
        <div class="well">
          ...
          <!-- File Input-->
          <link href="media/plugin/jQuery-UI-FileInput/css/enhanced.css" rel="Stylesheet">
      ...
      <footer>
        ...
        <!--daterangepicker-->
        <script type="text/javascript" src="/media/plugin/jQuery-UI-Date-Range-Picker/js/date.js"></script>
        <script type="text/javascript" src="/media/plugin/jQuery-UI-Date-Range-Picker/js/daterangepicker.jQuery.js"></script>

        <!--wijmo-->
        <script src="/media/plugin/wijmo/jquery.mousewheel.min.js" type="text/javascript"></script>
        <script src="/media/plugin/wijmo/jquery.bgiframe-2.1.3-pre.js" type="text/javascript"></script>
        <script src="/media/plugin/wijmo/jquery.wijmo-open.1.5.0.min.js" type="text/javascript"></script>


        <!-- FileInput -->
        <script src="/media/plugin/jQuery-UI-FileInput/js/enhance.min.js" type="text/javascript"></script>
        <script src="/media/plugin/jQuery-UI-FileInput/js/fileinput.jquery.js" type="text/javascript"></script>


        <!--init for this page-->
        <script type="text/javascript" src="media/js/demo.js"></script>
